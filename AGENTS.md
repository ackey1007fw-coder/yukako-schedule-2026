...
- **優花子さん本人が、自身の公開SNS（X / Instagram / TikTok等）へ自ら投稿した元写真は、本人性と元投稿URLを確認できる場合、個別の事前確認なしでサイトへ掲載してよい。** 元画像の保存と通常のリサイズ・レスポンシブ変換は可。顔のAI生成・加工や、意味・見え方を大きく変える編集はしない。
- あっきーが配信・動画などから作成した**スクリーンショット、画面録画、切り抜き動画、切り抜きサムネイル等の二次素材**を新たに掲載／転載するときは、実際に使う素材をオーナー「あっきー」から本人へ事前確認し、明確なOKを得たものだけ掲載する。サイト、X、Instagram、TikTok、YouTube、画像ZIPなどへの展開を対象とする。
- 二次素材で確認するのは素材そのものと掲載先・公開範囲。オーナーからの「各SNSに展開して」という制作依頼、過去の別素材への許可、元配信が公開済みという事実、AI側の判断は、今回の素材への本人承認の代わりにならない。
- **未確認・返信待ち・承認範囲不明の二次素材は非公開の下書きで止める**。未承認の二次素材を公開リポジトリ／PR、公開プレビュー、`public/`、公開共有URLへ先に置かない。限定公開も承認不要とはみなさない。
- 本人投稿の元写真でも、本人から取り下げ希望が出た場合は再利用・再投稿を止め、掲載先と派生物を確認して削除／非公開対応を優先する。掲載先ごとの実確認が終わるまで「削除済み」と報告しない。
- 後続エージェントへの非公開の引き継ぎには、二次素材について素材の識別子、承認状態、掲載先・公開範囲、確認日を残す。私的な会話・スクリーンショット・承認メッセージそのものは、この公開リポジトリやPRへ載せない。
...
- マージ前に必ず確認するチェックリスト（1つでも欠けたらマージしない）:
  ...
  6. 配信スクリーンショット・画面録画・切り抜き等の二次素材を新たに掲載／転載する変更では、対象素材・掲載先・公開範囲への本人承認を確認済み。本人が自身の公開SNSへ投稿した元写真は個別確認の対象外だが、本人性・元投稿URL・取り下げ有無を確認する。
