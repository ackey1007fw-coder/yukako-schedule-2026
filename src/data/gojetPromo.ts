...
export const gojetFeatureUpdates: GojetFeatureUpdate[] = [
  ...
  },
  {
    ...
    body:
      "終演後に公開された #ゆかJET オリジナル楽曲①は、美里が歌う対になる2曲。\n\n『未来は薔薇色』は、恋の未来を信じて進むルンルンな“一人ミュージカル”。今回は美里が前半に歌う構成で、メールの縦読みに気づく演出も新しく加わった。\n\n一転する『未来は灰色』は“怨み”を描く対の曲。暗転×明転と、赤ちゃんを使う演出は須田JETから受け継いだもの。\n\n同じ美里の歌が、薔薇色から灰色へ。歌詞は2枚の歌詞カードに。",
    caption:
      "＼ #ゆかJET オリジナル楽曲①✨／\n\n🧡美里の歌🧡\n\n🌹『未来は薔薇色』\n・ルンルンな”一人ミュージカル”\n・美里が前半に歌うのは初\n・メールの縦読みに気づくという、今までにない演出を追加📨\n\n🌫️『未来は灰色』\n・薔薇色と対になる”怨み”の曲\n・暗転×明転や赤ちゃん使用の演出は須田JETから継承🤱",
    postUrl: "https://x.com/yukako_produce/status/2090048586331676998",
    homepageUrl: "#gojet-finale-report",
    ctaLabel: "Xでオリジナル楽曲の投稿を見る",
    homepageLabel: "#ゆかJET 完走レポートを見る",
    roleTags: [
    ...
    photos: [
      {
        src: "/images/yukajet/2026-08-19-future-rose-lyrics.jpg",
        alt: "ピンクの薔薇で装飾された「6.未来は薔薇色（作：吉井優花子）」の歌詞カード"
      },
      {
        src: "/images/yukajet/2026-08-19-future-gray-lyrics.jpg",
        alt: "黒とグレーの枯れた薔薇で装飾された「7.未来は灰色（作：吉井優花子）」の歌詞カード"
      }
    ],
    // 引用元は8/14の #ゆかJET 終演報告。URLが未確認のため、リンクは設定しない。
    quotedPost: {
      author: "吉井優花子プロデュース公演",
      handle: "@yukako_produce",
      body:
        "8月14日の終演報告を引用した投稿。最初で最後の #ゆかJET を終えた感謝と、次は11月かもしれないという予告に続く。"
    }
  },
  {
  ...
  },
  {
    ...
    body:
      "「今日はC班ガールズ❗️🩷💛🩵」——C班でメグを演じた沼尾麻由佳さんが、早紀・ナッツ・ミッツとのツーショットを公開。\n\nメグとしては罵声を浴びせたり、睨みつけたりしていた3人。役を離れれば、3人がワイワイしている姿が大好き。\n\n早紀役の優花子さんについては、作戦でメグを一緒に歌おうと誘い出す場面が「ほんとーーーに毎回新鮮にムカついてました」。そして「なにをしても良いリアクションしてくださる」。安心してふっかけられたことへの感謝も。\n\n「P優花子さんのお話はまたまた後ほど」。",
