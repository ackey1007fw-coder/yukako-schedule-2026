...
const moreItems = [
  { label: "最新Instagramリール", href: "#latest-reel" }, { label: "これまでの歩み", href: "#highlights" },
  { label: "その他の出演", href: "#ojosama-band" }, { label: "プロフィール", href: "#profile" },
  { label: "秋田とのつながり", href: "#akita-roots" }, { label: "写真", href: "#gallery" },
