    ...
    sections: [
      {
        ...
        body: [
          ...
          "東京に拠点を置くメリットを活かし、果敢に挑戦してチャンスをつかんでいく——投稿の冒頭に、その決意があります。"
        ]
      },
      {
        heading: "家族と故郷への思い",
      ...
      },
      {
        ...
        body: [
          ...
          "そのうえで、やりたいことをやる行動力、まわりを考える思いやり、何度でも立ち上がる逞しさを得られたこと。経験を糧にできるところを強みとして、負けずに夢へ挑戦していく——この日の核心です。"
        ]
      },
      {
        heading: "いまにつながる原点",
        body: [
          ...
          "この日の記録は、その後の舞台デビュー、映像、ミスコン、プロデュース公演へと続く歩みの起点です。"
        ]
      }
    ],
    quotes: [
