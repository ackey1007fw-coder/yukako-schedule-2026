...
export function MobileActionDock({
  ...
  return (
    <nav
      aria-label="応援メニュー"
      className="fixed bottom-[calc(0.75rem+env(safe-area-inset-bottom))] left-2 z-[70] w-[calc(100vw-1rem)] max-w-[calc(100vw-1rem)] border border-white/80 bg-white/90 p-1 shadow-paper backdrop-blur-xl md:hidden"
    >
